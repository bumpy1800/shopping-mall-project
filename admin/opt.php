...
<?
	...
	$query = "select * from opt order by no10;";		// sql 정의
...
<?
	...
	echo("<tr bgcolor='#F2F2F2' height='20'>	
		<td width='50'  align='center'>$row[no10]</td>
		<td width='250' align='left'>$row[name10]</td>
		<td width='100' align='center'>
			<a href='opt_edit.php?no1=$row[no10]'>수정</a>/
			<a href='opt_delete.php?no1=$row[no10]' onclick='javascript:return confirm(\"삭제할까요 ?\");'>삭제</a>
		</td>
		<td width='100' align='center'><a href='opts.php?no1=$row[no10]'>소옵션편집</a></td>
	</tr>");
	}
?>
</table>
