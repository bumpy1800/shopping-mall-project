...
<?
	...
	$contents=stripslashes($row[contents10]);
?>
<html>
<head>
...
<table width="800" border="1" cellpadding="2" style="border-collapse:collapse">
	<tr height="23"> 
		...
		<td width="700" bgcolor="#F2F2F2">
			<?
				...
				{
				   if ($row[menu10]==$i)
			       echo("<option value='$i' selected>$a_menu[$i]</option>"); // 진혁이형한테 이 for문 원리 물어보기
				   else
	...
	<tr height="23"> 
		...
		<td width="700"  bgcolor="#F2F2F2">
			<input type="text" name="code" value="<?=$row[code10]?>" size="20" maxlength="20">
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		...
		<td width="700"  bgcolor="#F2F2F2">
			<input type="text" name="coname" value="<?=$row[coname10]?>" size="30" maxlength="30">
		</td>
	</tr>
	<tr> 
		<td width="100" bgcolor="#CCCCCC" align="center">판매가</td>
		<td width="700"  bgcolor="#F2F2F2">
			<input type="text" name="price" value="<?=$row[price10]?>" size="12" maxlength="12"> 원
		</td>
	</tr>
	<tr> 
		...
		<td width="700"  bgcolor="#F2F2F2">
	<?
	$query="select * from opt order by no10";
	...
	$count=mysqli_num_rows($result);    // 레코드개수
		echo("<select name='opt2'>");
			        ...
			        echo("<option value='0'>옵션선택2</option>");
...
?>
	...
	<tr> 
		...
		?>
			할인율 : <input type="text" name="discount" value="<?=$row[discount10]?>" size="3" maxlength="3"> %
		</td>
	</tr>
	<?
		$regday1=substr($row[regday10],0,4);      
	    $regday2=substr($row[regday10],5,2);
	    $regday3=substr($row[regday10],8,2);
	?>
	<tr> 
				...
				<tr>
					<td>
						<table width="390" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
									<input type='hidden' name='imagename1' value='<?=$row[image110]?>'>
									&nbsp;<input type="checkbox" name="checkno1" value="1"> <b>이미지1</b>: <?=$row[image110]?>
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tr>
								<td>
									<input type='hidden' name='imagename2' value='<?=$row[image210]?>'>
									&nbsp;<input type="checkbox" name="checkno2" value="1"> <b>이미지2</b>: <?=$row[image210]?>
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<tr>
								<td>
									<input type='hidden' name='imagename3' value='<?=$row[image310]?>'>
									&nbsp;<input type="checkbox" name="checkno3" value="1"> <b>이미지3</b>: <?=$row[image310]?>
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<table width="390" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td  valign="middle">&nbsp;
									<img src="../product/<?=$row[image110]?>" width="50" height="50" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row[image110]?>')">&nbsp;
									<img src="../product/<?=$row[image210]?>" width="50" height="50" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row[image210]?>')">&nbsp;
									<img src="../product/<?=$row[image310]?>"  width="50" height="50" border="1" style='cursor:hand' onclick="imageView('../product/<?=$row[image310]?>')">&nbsp;
								</td>
							</tr>				 
						</table>
					</td>
					<td>
						<td align="right" width="310"><img name="big" src="../product/<?=$row[image110]?>" width="300" height="300" border="1"></td>
					</td>
				</tr>
			</table>
