...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td height="30" align="center"><img src="images/order.png" width="100%" height="30" border="0"></td>
				</tr>
				<tr><td height="13"></td></tr>
			</table>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="23%">
				<tr>
					<td><img src="images/order_title1.gif" width="65" height="15" border="0" align="right"></td>
				</tr>
...
<?
			...
			<input type="hidden" name="o_addr"   value="<?=$o_addr?>">
