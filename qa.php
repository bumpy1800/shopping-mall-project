...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td height="30"><img src="images/qa_title.gif" width="100%" height="30" border="0"></td>
				</tr>
				<tr><td height="13"></td></tr>
			</table>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="70%" class="cmfont" align="center">
				...
				<tr height="25" bgcolor="#FFFFFF">	
					...
					<td><a href="qa_read.php?no=1&page=1&sel1=1&text1="><font color="#4186C7">새소식1</font></a></td>	
				...
				<tr height="25" bgcolor="#FFFFFF">	
					...
					<td><img src="images/i_re.gif" border="0" align="absmiddle">&nbsp;<a href="qa_read.php?no=2&page=1&sel1=1&text1="><font color="#4186C7">Re:새소식1</font></a></td>	
				...
				<tr height="25" bgcolor="#FFFFFF">	
					...
					<td>&nbsp;&nbsp;&nbsp;
						<img src="images/i_re.gif" border="0" align="absmiddle">&nbsp;<a href="qa_read.php?no=3&page=1&sel1=1&text1="><font color="#4186C7">Re:새소식1</font></a>
					</td>	
					<td width="90" align="center"><font color="#686868">관리자</font></td>	
					<td width="90" align="center"><font color="#686868">2007-01-02</font></td>	
				...
				<tr height="25" bgcolor="#FFFFFF">	
					...
					<td><a href="qa_read.php?no=4&page=1&sel1=1&text1="><font color="#4186C7">새소식2</font></a></td>	
					<td width="90" align="center"><font color="#686868">홍길동</font></td>	
				...
				<tr height="25" bgcolor="#FFFFFF">	
					...
					<td><a href="qa_read.php?no=5&page=1&sel1=1&text1="><font color="#4186C7">새소식3</font></a></td>	
					<td width="90" align="center"><font color="#686868">홍길동</font></td>	
					<td width="90" align="center"><font color="#686868">2007-01-01</font></td>	
					<td width="90" align="center"><font color="#686868">10</font></td>
				</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
				<tr>
					<td height="30" class="cmfont" align="center">
						...
						<a href="qa.php?page=2&sel1=&text1="><font color="#7C7A77">[2]</font></a>&nbsp;
						<a href="qa.php?page=3&sel1=&text1="><font color="#7C7A77">[3]</font></a>&nbsp;
