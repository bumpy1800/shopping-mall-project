...
<script language = "javascript">
			...
			function cart_edit(kind,pos) 
			{
				if (kind=="deleteall") 
				{
					location.href = "juso_edit11.php?kind=deleteall";
				} 
				else if (kind=="delete")	
				{
					location.href = "juso_edit11.php?kind=delete&pos="+pos;
				} 
				else if (kind=="insert")	
				{
					var num=eval("form2.num"+pos).value;
					location.href = "juso_edit11.php?kind=insert&pos="+pos+"&num="+num;
				}
				else if (kind=="update")	
				{
					var num=eval("form2.num"+pos).value;
					location.href = "juso_edit11.php?kind=update&pos="+pos+"&num="+num;
				}
			}
...
<table width="600" border="0">
	<form name="form1" method="post" action="juso_list1.php">
	<tr>
		<td width="400">&nbsp
			이름 : <input type="text" name="text1" size="10" value="">
			<input type="button" value="검색" onClick="javascript:form1.submit();">
		</td>
		<td align="right"><a href="juso_new1.html">입력</a>&nbsp</td>
	</tr>
	</form>
</table>
	...
	if (!$n_cart) $n_cart=0;
		...
		for ($i=1;  $i<=$n_cart;  $i++)
		{
			if ($cart[$i])
			{
				...
				<td width='70'  align='center'><a href='juso_edit1.php?no=$i'>$name</a></td>
				<td width='100'  align='center'>$tel</td>
				<td width='50'  align='center'>$sm1</td>
