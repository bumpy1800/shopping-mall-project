...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="25%" class="cmfont">
				<tr>
					<td align="right"><img src="images/login_title1.gif" width="85" height="15" border="0"></td>
				</tr>
				<tr><td height="10"></td></tr>
			</table>

			<table border="0" cellpadding="5" cellspacing="1" width="100%" bgcolor="F6F6F6">
				<tr>
					<td align="center" bgcolor="FFFFFF">
						<table border="0" cellpadding="0" cellspacing="30" width="200" bgcolor="white">
							<tr>
								<td align="center">
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
			...
			<table border="0" cellpadding="0" cellspacing="0" width="80%" class="cmfont">
				<tr>
