...
<!-------------------------------------------------------------------------------------------->	
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td height="30" align="center">
						<img src="images/order.png" width="100%" height="30" border="0">
					</td>
				</tr>
				<tr><td height="13"></td></tr>
			</table>
			<table border="0" cellpadding="0" cellspacing="0" width="25%" class="cmfont">
				<tr>
					<td><img src="images/order_title1.gif" border="0" align="right"></td>
				</tr>
				<tr><td height="15"></td></tr>
			</table>
			<br><br>
			<table border="0" cellpadding="5" cellspacing="1" width="70%" bgcolor="cccccc" align="center">
				<tr>
